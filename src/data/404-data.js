...
const data404 = {
  data: {
    ...
    header: {
      imagePath: "/src/assets/uft-plane-taking-off-runway.jpg",
      ...
      paragraph: `It appears the page you're trying to access has already taken off, if you were trying to get some useful information please inform us so we can better accomodate your needs, otherwise just head on back to landing!`,
      buttons: [
        {
          name: "Home Page",
          link: "/",
