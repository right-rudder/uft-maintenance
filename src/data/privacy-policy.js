    ...
    content: [
      {
        ...
        paragraphs: [
          "Universal Aircraft Maintenance operates the https://www.repairuam.com/ website. This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decides to use our Service, the Universal Aircraft Maintenance website.",
      ...
      },
      {
        ...
        paragraphs: [
          "We may employ third-party companies and individuals for the following reasons: To facilitate our Service, to provide the Service on our behalf, to perform Service-related services, or to assist us in analyzing how our Service is used.",
      ...
      },
      {
        heading: "Security",
        paragraphs: [
          "We value your trust in providing us your Personal Information, so we strive to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.",
        ],
      },
      {
